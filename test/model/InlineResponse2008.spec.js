...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GasperDominusApi.InlineResponse2008();
  });
  ...
  describe('InlineResponse2008', function() {
    it('should create an instance of InlineResponse2008', function() {
      ...
      //var instane = new GasperDominusApi.InlineResponse2008();
      //expect(instance).to.be.a(GasperDominusApi.InlineResponse2008);
    });
    ...
    it('should have the property dominus (base name: "dominus")', function() {
      // uncomment below and update the code to test the property dominus
      //var instane = new GasperDominusApi.InlineResponse2008();
      //expect(instance).to.be();
    });
