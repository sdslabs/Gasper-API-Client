...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GasperKazeApi.DbsApi();
  });
  ...
  describe('DbsApi', function() {
    ...
    describe('transferDbByUser', function() {
      it('should call transferDbByUser successfully', function(done) {
        //uncomment below and update the code to test transferDbByUser
        //instance.transferDbByUser(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
