...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GasperKazeApi.AppsApi();
  });
  ...
  describe('AppsApi', function() {
    ...
    describe('fetchMetricsByUser', function() {
      it('should call fetchMetricsByUser successfully', function(done) {
        //uncomment below and update the code to test fetchMetricsByUser
        //instance.fetchMetricsByUser(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchTerminalByUser', function() {
      it('should call fetchTerminalByUser successfully', function(done) {
        //uncomment below and update the code to test fetchTerminalByUser
        //instance.fetchTerminalByUser(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
