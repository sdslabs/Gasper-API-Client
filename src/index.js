...
* <pre>
* var GasperApi = require('index'); // See note below*.
* var xxxSvc = new GasperApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new GasperApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new GasperApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new GasperApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
