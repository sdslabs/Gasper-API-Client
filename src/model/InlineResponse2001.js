    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Instances]);
            }
        }
        return obj;
    }
...
/**
     * @return {Array.<module:model/Instances>}
     */
    getData() {
        return this.data;
    }
    ...
    /**
     * @param {Array.<module:model/Instances>} data
     */
    setData(data) {
        this['data'] = data;
    }
...
/**
 * @member {Array.<module:model/Instances>} data
 */
